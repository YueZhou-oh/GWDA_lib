...
python3.7 -m inference.gwpe_main train new nde \
    --data_dir ../../../dataset/pe/GW150914_sample_prior_basis/ \
    --model_dir models/GW170104_sample_uniform_100basis_all_uniform_prior/ \
    --basis_dir ../../../dataset/pe/GW150914_sample_prior_basis/ \
