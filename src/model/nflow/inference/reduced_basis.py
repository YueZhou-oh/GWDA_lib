...
class SVDBasis(object):
    ...
    def basis_coefficients_to_fseries(self, coefficients, truncate=None):
        ...
        return coefficients @ self.Vh[:truncate, :]

    def fseries_to_basis_coefficients(self, fseries, truncate=None):
        ...
        return fseries @ self.V[:, :truncate]
