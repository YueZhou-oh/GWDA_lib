...
if __name__ == "__main__":
    ...
    wfd.test_reduced_basis(n_test=10000 // div, prior_fun=wfd._sample_prior, fiducial_distance=100, truncate=100)
    # wfd.test_reduced_basis(n_test=10000//div, prior_fun=wfd._sample_prior_posterior,
    #                        fiducial_distance=1000, truncate=None)
    wfd.test_reduced_basis(n_test=10000 // div, prior_fun=wfd._sample_prior_posterior, fiducial_distance=100, truncate=100)
