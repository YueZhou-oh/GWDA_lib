...
if __name__ == "__main__":
    ...
    wfd = wfg.WaveformDataset(spins_aligned=False, domain="RB", extrinsic_at_train=True, sampling_from="uniform")
    ...
    # wfd.test_reduced_basis(n_test=10000//div, prior_fun=wfd._sample_prior_posterior,
    #                        fiducial_distance=1000, truncate=100)
    wfd.test_reduced_basis(n_test=10000 // div, prior_fun=wfd._sample_prior, truncate=None, save_dir="./data/{}_uniform_prior".format(event))
    wfd.test_reduced_basis(n_test=10000 // div, prior_fun=wfd._sample_prior, truncate=100, save_dir="./data/{}_uniform_prior".format(event))
    wfd.test_reduced_basis(n_test=10000 // div, prior_fun=wfd._sample_prior_posterior, truncate=None, save_dir="./data/{}_uniform_prior".format(event))
    wfd.test_reduced_basis(n_test=10000 // div, prior_fun=wfd._sample_prior_posterior, truncate=100, save_dir="./data/{}_uniform_prior".format(event))
    ...
    # wfd.test_reduced_basis(n_test=10000//div, prior_fun=wfd._sample_prior,
    #                         truncate=100)
    wfd.test_reduced_basis(n_test=10000 // div, prior_fun=wfd._sample_prior_posterior, truncate=None, save_dir="./data/{}_posterior_prior".format(event))
    wfd.test_reduced_basis(n_test=10000 // div, prior_fun=wfd._sample_prior_posterior, truncate=100, save_dir="./data/{}_posterior_prior".format(event))
    # wfd.test_reduced_basis(n_test=150000//div,
    #                        prior_fun=wfd._sample_prior,
    #                        fiducial_distance=None,
    #                        truncate=None,
