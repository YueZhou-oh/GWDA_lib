...
def initialize_model_parallel(tensor_model_parallel_size_=1, pipeline_model_parallel_size_=1, virtual_pipeline_model_parallel_size_=None):
    """
...
def is_pipeline_first_stage(ignore_virtual=False):
    ...
    if not ignore_virtual:
        if get_virtual_pipeline_model_parallel_world_size() is not None and get_virtual_pipeline_model_parallel_rank() != 0:
            return False
...
def is_pipeline_last_stage(ignore_virtual=False):
    ...
    if not ignore_virtual:
        ...
        if virtual_pipeline_model_parallel_world_size is not None and get_virtual_pipeline_model_parallel_rank() != (virtual_pipeline_model_parallel_world_size - 1):
            return False
