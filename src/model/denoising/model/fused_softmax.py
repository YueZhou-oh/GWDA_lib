...
class FusedScaleMaskSoftmax(torch.nn.Module):
    ...
    def __init__(
        ...
        assert not (self.input_in_fp16 and self.input_in_bf16), "both fp16 and bf16 flags cannot be active at the same time."
    ...
    def forward(self, input, mask):
        ...
        if self.input_in_float16 and mask is not None and custom_kernel_constraint and self.scaled_masked_softmax_fusion:
