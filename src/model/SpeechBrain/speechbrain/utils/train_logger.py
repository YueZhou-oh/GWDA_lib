...
class FileTrainLogger(TrainLogger):
    ...
    def _stats_to_string(self, stats, dataset=None):
        ...
        return ", ".join([self._item_to_string(k, v, dataset) for k, v in stats.items()])
...
class WandBLogger(TrainLogger):
    ...
    def __init__(self, *args, **kwargs):
        try:
            ...
            self.run = kwargs.pop("initializer", None)(*args, **kwargs, config=config_dict)
...
class ProgressSampleLogger:
    ...
    def __init__(self, output_path, formats=None, format_defs=None, batch_sample_size=1):
    ...
    def remember(self, **kwargs):
        ...
        """
        self.progress_samples.update({key: detach(value) for key, value in kwargs.items()})
