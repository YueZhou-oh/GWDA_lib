...
class EnhanceResnet(torch.nn.Module):
    ...
    def __init__(
        ...
        self.CNN = sb.nnet.containers.Sequential(input_shape=[None, None, n_fft // 2 + 1])
        ...
        self.DNN = sb.nnet.containers.Sequential(input_shape=self.CNN.get_output_shape())
...
class ConvBlock(torch.nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = sb.nnet.CNN.Conv2d(in_channels=channels, out_channels=channels, kernel_size=3)
